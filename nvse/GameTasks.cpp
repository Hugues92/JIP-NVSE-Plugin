...
void ModelLoader::QueueReference(TESObjectREFR* refr, UInt32 arg1, UInt32 arg2)
{
	ThisStdCall(kModelLoader_QueueReference, this, refr, arg1, arg2);	// arg1 is encoded based on the parent cell and arg2 is most likely a boolean
}
