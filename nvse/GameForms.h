...
public:
	...
	TESForm*	unk04;	// 04	ENCH or SPEL
	UInt16	unk08;		// 08	Unarmed attack animation
	UInt16	pad0A;		// 0A
};
...
public:
	...
	struct Target
	{
		...
		TargetData*		target;			// 00C
		// struct {
		//		array	BSSimpleArray<ParentSpaceNode,1024>	// 000
		//		array	BSSimpleArray<TeleportLink,1024>	// 010
		//		020
		//		02C
		// }
	};
...
public:
	...
	void					* unk0C4;			// 0C4	structure containing at 4C a list of scripted references, 5C a list of refer with activateRefChildren
	float					unk0C8;				// 0C8
	UInt32					unk0CC;				// 0CC
	UInt32					unk0D0;				// 0D0
...
public:
	...
	struct Offset_Data
	{
		UInt32	** unk000;	// 000 array of UInt32 stored in OFST record.
...
public:
	...
	UInt8	pad9D[3];						// 09D
	float	holdTimerMin;					// 100
	float	holdTimerMax;					// 104
	UInt16	csFlags;						// 108
	UInt8	pad10A[2];						// 10A
	UInt8	acrobaticDodgeChance;			// 10C
	UInt8	rushAttackChance;				// 10D
	UInt8	pad10E[2];						// 10E
	float	rushAttackDistMult;				// 110
	float	dodgeFatigueModMult;			// 114
	float	dodgeFatigueModBase;			// 118
	float	encumSpeedModBase;				// 11C
	float	encumSpeedModMult;				// 120
	float	dodgeUnderAttackMult;			// 124
	float	dodgeNotUnderAttackMult;		// 128
	float	dodgeBackUnderAttackMult;		// 12C
	float	dodgeBackNotUnderAttackMult;	// 130
	float	dodgeFWAttackingMult;			// 134
	float	dodgeFWNotAttackingMult;		// 138
	float	blockSkillModMult;				// 13C
	float	blockSkillModBase;				// 140
	float	blockUnderAttackMult;			// 144
	float	blockNotUnderAttackMult;		// 148
	float	attackSkillModMult;				// 14C
	float	attackSkillModBase;				// 150
	float	attackUnderAttackMult;			// 154
	float	attackNotUnderAttackMult;		// 158
	float	attackDuringBlockMult;			// 15C
	float	powerAttackFatigueModBase;		// 160
	float	powerAttackFatigueModMult;		// 164
